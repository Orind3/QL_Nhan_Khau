...
public class ThongKeController {
    ...
    public void thongKeThuPhiClick(MouseEvent mouseEvent) throws IOException {
        Pane thongKeThuPhiPane = FXMLLoader.load(getClass().getResource("/view/thongKe/thongkeui.fxml"));
        mainPane.getChildren().clear();
        mainPane.getChildren().add(thongKeThuPhiPane);
    }
}
